...
fn = '../datasets/musical_instruments_preprocessed.txt'
...
#        print(hotel_id, city_state, author_id, review_class)
    ...
    calc_data['author'][author_id]['classes'][review_class]['total'] += 1
    ...
    calc_data['author_brand'][author_brand]['classes'][review_class]['total'] += 1
    calc_data['author_brand'][author_brand]['total'] += 1
    calc_data['total'] += 1
